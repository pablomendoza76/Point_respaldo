...
import { IconosComponent } from '@styles/catalogo/Iconos_Modulos_Svg/iconos/iconos.component'
...
export class DynamicMenuComponent implements OnInit {
  ...
  private detectarModuloDesdeUrl(): string | undefined {
    ...
    return this.menuPadre.find((padre) => (this.menuHijosMap[padre.label] || []).some((hijo) => url.includes(hijo.route || '')))?.label
  }
